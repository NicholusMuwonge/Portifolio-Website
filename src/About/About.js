            ...
            <div className="sec">
              <div className="about">
                ...
                <p class="text-justify bio">
                  ...
                  the Industry accepted standards. Every now and then, I have
                  made it a point to contribute to open source to improve my
                  skills and get the software more functional.
                  <br />
                  <br />
